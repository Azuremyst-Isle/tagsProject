const apiBase = 'https://app-python-rfiproject-test-01.azurewebsites.net/';
...
function addItem() {
    ...
    .then(() =>  window.location.href = 'index.html'// Redirect to home page after adding an item
    );
}
...
function getItem() {
    ...
    fetch(apiBase + `/items/${tag}`)
        ...
        .then(data => {
            ...
            if (data) {
                const formattedDate = new Date(data.last_updated).toLocaleString('en-GB', {
